                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade show active edit-profile-tab" role="tabpanel" aria-labelledby="edit-profile-tab">
                                                        ...
                                                        <div id="avatar_container">
                                                            <div class="collapseOne card-collapse collapse @if($user->profile->avatar_status == 0) show @endif">
                                                                <div class="card-body">
                                                                    ...
                                                                    <center>
                                                                        @if (isset($user->verification) && $user->verification->is_verified == 1)
                                                                            <div class="badge badge-success"> Verified </div>
                                                                        @else
                                                                            <div class="badge badge-warning"> Waiting for Verification </div>
                                                                        @endif
                                                                    </center>
                                                                </div>
                                                            </div>
                                                ...
                                                {!! Form::model($user->profile, ['method' => 'PUT', 'route' => ['public.verification.store', $user->id], 'id' => 'user_profile_form', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                                                    {{ csrf_field() }}
                                                    <div class="form-group has-feedback {{ $errors->has('address') ? ' has-error ' : '' }}">
                                                        {!! Form::label('address', trans('profile.label-address') , array('class' => 'col-12 control-label')); !!}
                                                        <div class="col-12">
                                                            {!! Form::textarea('address', isset($user->verification) ? $user->verification->address : '', array('id' => 'address', 'class' => 'form-control', 'placeholder' => trans('profile.ph-address'))) !!}
                                                    ...
                                                    <div class="form-group has-feedback {{ $errors->has('phone') ? ' has-error ' : '' }}">
                                                        ...
                                                        <div class="col-12">
                                                            {!! Form::text('phone', isset($user->verification) ? $user->verification->phone : '', array('id' => 'phone', 'class' => 'form-control', 'placeholder' => trans('profile.ph-phone'))) !!}
                                                            <span class="glyphicon glyphicon-pencil form-control-feedback" aria-hidden="true"></span>
                                                            @if ($errors->has('phone'))
                                                                <span class="help-block">
                                                    ...
                                                    <div class="form-group has-feedback">
                                                        <div class="col-12">
                                                            ...
                                                            @if ($user->verification != null && $user->verification->attachment != '')
                                                                {!! \Helper::get_lampiran($user->verification->attachment) !!}
                                                                <br>
                                                            @else
                                                                -
                                                            @endif
